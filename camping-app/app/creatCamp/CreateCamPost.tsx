...
const CampingPost = () => {
  ...
  const handleImagePick = async () => {
    try {
      ...
      alert(
        "An unexpected error occurred while picking the image. Please try again."
      );
    }
  };
  ...
  const handlePost = async () => {
    try {
      ...
      const response = await axios.post(
        "http://192.168.10.13:5000/api/camps/add",
        formData,
        {
          headers: {
          ...
          <View style={styles.modalContent}>
            ...
            <View style={styles.buttonRow}>
              ...
              <TouchableOpacity
                style={[
                  styles.skipButton,
                  { backgroundColor: click ? "#B3492D" : "#ccc" },
                ]}
