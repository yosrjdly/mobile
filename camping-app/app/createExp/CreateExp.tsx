...
import { View, Text, TextInput, StyleSheet, Alert, Image, ScrollView, TouchableOpacity } from 'react-native';
...
const CreateExperience = () => {
  ...
  const handlePost = async () => {
    ...
    try {
      ...
      const response = await axios.post('http://192.168.10.7:5000/api/experienceTip/add', formData, {
        headers: {
...
const styles = StyleSheet.create({
  ...
  imagePickerButton: {
    backgroundColor: '#B3492D',  // Updated button color
    paddingVertical: 15,
    alignItems: 'center',
    borderRadius: 5,
    marginVertical: 10,
